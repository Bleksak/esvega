...
if [ "$COMMITS_BEHIND" -gt 15 ]; then
  printf '{"systemMessage":"Caliber: agent configs are %s commits behind. Run /run/user/1000/fnm_multishells/93028_1777820967732/bin/caliber refresh to sync."}' "$COMMITS_BEHIND"
fi
